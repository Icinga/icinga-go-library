...
func (r *Config) Validate() error {
	...
	if r.PasswordFile != "" {
		rawPassword, err := os.ReadFile(r.PasswordFile)
		if err != nil {
			return errors.Wrapf(err, "reading PASSWORD_FILE %q failed", r.PasswordFile)
		}
		r.Password = strings.TrimSpace(string(rawPassword))
		r.PasswordFile = ""
	}
